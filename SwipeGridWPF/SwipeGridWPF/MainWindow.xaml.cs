...
namespace SwipeGridWPF
{
	...
	public partial class MainWindow : Window
	{
		...
		private void btnInsert_Click(object sender, RoutedEventArgs e)
		{
			...
			foreach (var City in listDestination)
			{
				comand.CommandText = $"INSERT INTO Gorod(CityName) VALUES('{City}')";
		...
		private void btnSale_Click(object sender, RoutedEventArgs e)
		{
			...
			var comand = connection.CreateCommand();
			comand.CommandText =
				$"INSERT INTO Bilet(FirstName, LastName, Source, Destination, Class, Way, DateOne, DateTwo, Price) VALUES('{txtFirstName.Text}','{txtSecondName.Text}', (SELECT Id FROM Gorod WHERE CityName = '{comboBoxSource.Text}'), " +
				$"(SELECT Id FROM Gorod WHERE CityName = '{comboBoxDestination.Text}'), '{comboBoxClass.Text}', {(rbTo.IsChecked == true ? 0 : 1)}," +
